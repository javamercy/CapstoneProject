        ...
        while (SDL_PollEvent(&event) != 0) {
            if (event.type == SDL_QUIT) {
                ...
                switch (event.key.keysym.sym) {
                    case SDLK_SPACE: mSimulation.togglePauseSimulation();
                        break;
                    case SDLK_ESCAPE: mRunning = false;
                        break;
                    case SDLK_KP_PLUS: mSimulation.increaseZoom();
                        break;
                    case SDLK_KP_MINUS: mSimulation.decreaseZoom();
                        break;
                    case SDLK_RIGHTBRACKET: mSimulation.increaseTimeMultiplier();
                        break;
                    case SDLK_LEFTBRACKET: mSimulation.decreaseTimeMultiplier();
                        break;
                    case SDLK_r: mSimulation.reset();
                        break;
                    case SDLK_1: mSimulation.reset(loadSimulation1Parameters());
                        break;
                    case SDLK_2: mSimulation.reset(loadSimulation2Parameters());
                        break;
                    case SDLK_3: mSimulation.reset(loadSimulation3Parameters());
                        break;
                    case SDLK_4: mSimulation.reset(loadSimulation4Parameters());
                        break;
                    case SDLK_5: mSimulation.reset(loadSimulation5Parameters());
                        break;
                    case SDLK_6: mSimulation.reset(loadSimulation6Parameters());
                        break;
                    case SDLK_7: mSimulation.reset(loadSimulation7Parameters());
                        break;
                    case SDLK_8: mSimulation.reset(loadSimulation8Parameters());
                        break;
                    case SDLK_9: mSimulation.reset(loadSimulation9Parameters());
                        break;
                    case SDLK_0: mSimulation.reset(loadSimulation0Parameters());
                        break;
                }
            }
        }
