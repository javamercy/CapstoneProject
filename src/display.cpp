...
bool Display::createRenderer(std::string title, int screenWidth, int screenHeight) {
    ...
    // Create window
    mWindow = SDL_CreateWindow(title.c_str(), SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, screenWidth,
                               screenHeight, 0);
    if (mWindow == nullptr) {
...
void Display::drawText_MainFont(const std::string text, const Vector2 pos, const double scale, const SDL_Color color,
                                bool centered) {
...
std::vector<Vector2> transformPoints(const std::vector<Vector2> &points, const Vector2 &position,
...
std::vector<std::vector<Vector2> > transformPoints(const std::vector<std::vector<Vector2> > &dataset,
...
std::vector<std::vector<Vector2> > offsetPoints(const std::vector<std::vector<Vector2> > &dataset,
