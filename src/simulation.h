...
struct SimulationParams {
    ...
    SimulationParams()
        : profile_name(""),
          ...
          gps_enabled(true), gps_update_rate(1.0), gps_position_noise_std(3), gps_error_probability(0.0),
          gps_denied_x(0.0), gps_denied_y(0.0), gps_denied_range(-1.0),
          lidar_enabled(false), lidar_id_enabled(true), lidar_update_rate(10.0), lidar_range_noise_std(3),
          lidar_theta_noise_std(0.02),
